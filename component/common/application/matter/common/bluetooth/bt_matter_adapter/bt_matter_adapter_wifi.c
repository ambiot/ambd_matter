...
extern void bt_matter_adapter_app_deinit(void);
...
#endif
			{
				gap_conn_state = bt_matter_adapter_gap_conn_state;
			}
...
#endif
	{
		bt_matter_adapter_app_deinit();
	}

	os_task_delete(NULL);
}

void bt_matter_adapter_wifi_init(void)
{
	BC_cmd_task_init();
...
void bt_matter_adapter_wifi_deinit(void)
{
...
#endif
		{
			gap_dev_state = bt_matter_adapter_gap_dev_state;
		}
