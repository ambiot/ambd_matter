...
*****************************************************************************************
  * @file    bt_matter_adapter_config.h
...
#ifndef _BT_MATTER_ADAPTER_CONFIG_H_
#define _BT_MATTER_ADAPTER_CONFIG_H_
...
/** @defgroup BT_Config_UUIDs BT Config UUIDs
  ...
  * @{
  */
#define GATT_UUID_BT_MATTER_ADAPTER_PROFILE					0xFF01
